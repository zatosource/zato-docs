...
"use strict";const keyCodes=Object.freeze({DOWN:40,END:35,ESC:27,HOME:36,LEFT:37,PAGEDOWN:34,PAGEUP:33,RETURN:13,RIGHT:39,SPACE:32,TAB:9,UP:38});function copyToClipboard(a){const b=document.getSelection();if(b){const c=document.createElement("textarea");if(c.value=a,c.setAttribute("readonly",""),c.style.position="absolute",c.style.left="-9999px",document.body.appendChild(c),0<b.rangeCount){const a=b.getRangeAt(0);c.select(),document.execCommand("copy"),document.body.removeChild(c),b.removeAllRanges(),b.addRange(a)}else c.select(),document.execCommand("copy"),document.body.removeChild(c)}}function saveFile(a,b){const c=document.createElement("a");c.setAttribute("href","data:text/plain;charset=utf-8,"+encodeURIComponent(b)),c.setAttribute("download",a),c.style.display="none",document.body.appendChild(c),c.click(),document.body.removeChild(c)}function printText(a){const b=window.open("","","left=0,top=0,width=100,height=100,toolbar=0,scrollbars=0,status=0,location=0,menubar=0",!1);b&&(b.document.write("<html><body><pre><code>"+a+"</code></pre></html>"),b.document.close(),b.focus(),b.print(),b.close())}function navigateToUrlOrRoot(a){const b=new XMLHttpRequest;b.open("GET",a,!0),b.onreadystatechange=()=>{if(4===b.readyState&&404===b.status){const b=new URL(a);b.pathname="",a=b.toString()}window.location.href=a},b.send()}function createCookie(a,b){document.cookie=a+"="+b+"; path=/"}function getById(a){return document.getElementById(a)}function listen(a,b,c){a&&a.addEventListener(b,c)}function toggleAttribute(a,b){"true"===a.getAttribute(b)?a.setAttribute(b,"false"):a.setAttribute(b,"true")}function isPrintableCharacter(a){return 1===a.length&&null!=a.match(/\S/)}
"use strict";function sendFeedback(a,b){gtag("event","click-"+a,{event_category:"Helpful",event_label:window.location.pathname,value:b});const c=getById("feedback-initial");c&&(c.style.display="none");const d=getById("feedback-thankyou");d&&(d.style.display="inline-block")}
...
"use strict";function handleThemes(){applyStyleSheet(currentTheme),listen(getById(lightThemeItem),click,()=>(applyStyleSheet(lightTheme),localStorage.setItem(themeStorageItem,lightTheme),!1)),listen(getById(darkThemeItem),click,()=>(applyStyleSheet(darkTheme),localStorage.setItem(themeStorageItem,darkTheme),!1))}handleThemes();
...
"use strict";function handleHeader(){function a(){const a=getById(c);a&&a.classList.remove(f);const b=getById(d);b&&b.classList.remove(f);const g=getById(e);g&&(g.value="")}function b(){const a=getById(c);a&&a.classList.add(f);const b=getById(d);b&&b.classList.add(f);const g=getById(e);g&&g.focus()}const c="search-form",d="header-links",e="search-term",f="show-search",g="open-hamburger";listen(document.body,keyup,b=>{27===b.which&&(a(),closeActiveOverlay())}),listen(getById("search-show"),click,a=>{a.preventDefault(),b()}),listen(getById("search-close"),click,b=>{b.preventDefault(),a()}),listen(getById("hamburger"),click,()=>{const a=getById("brand");a&&a.classList.toggle(g);const b=getById(d);b&&b.classList.toggle(g);const f=getById(c);f&&f.classList.toggle(g);const h=getById(e);h&&h.focus()})}handleHeader();
"use strict";function handleSidebar(){function a(a){const b=a.nextElementSibling;b&&(b.classList.toggle("show"),toggleAttribute(a,ariaExpanded),b.style.maxHeight=b.classList.contains("show")?b.scrollHeight+"px":"")}const b=getById("sidebar");if(!b)return;b.querySelectorAll(".body").forEach(a=>{a.querySelectorAll(button).forEach(a=>{listen(a,click,a=>{const b=a.currentTarget;b.classList.toggle("show");const c=b.nextElementSibling;if(!c)return;const d=c.nextElementSibling;if(!d)return;toggleAttribute(d,ariaExpanded);let e=d;do e=e.parentElement;while(!e.classList.contains("body"));e.style.maxHeight=e.scrollHeight+"px"})}),window.observeResize(a,a=>{null!==a.style.maxHeight&&""!==a.style.maxHeight&&(a.style.maxHeight=a.scrollHeight+"px")})});const c=[];b.querySelectorAll(".header").forEach(a=>{c.push(a)});const d=new KbdNav(c);b.querySelectorAll(".header").forEach(b=>{b.classList.contains("dynamic")&&(listen(b,click,()=>{a(b)}),listen(b,keydown,c=>{const f=c,e=f.key;if(f.ctrlKey||f.altKey||f.metaKey);else if(f.shiftKey)isPrintableCharacter(e)&&d.focusElementByChar(e);else{switch(f.keyCode){case keyCodes.UP:d.focusPrevElement();break;case keyCodes.DOWN:d.focusNextElement();break;case keyCodes.HOME:d.focusFirstElement();break;case keyCodes.END:d.focusLastElement();break;case keyCodes.RETURN:a(b);break;case keyCodes.TAB:return;default:isPrintableCharacter(e)&&d.focusElementByChar(e);}f.preventDefault(),f.cancelBubble=!0}}))}),b.querySelectorAll(".body").forEach(a=>{if(a.classList.contains("default")){a.style.maxHeight=a.scrollHeight+"px",a.classList.toggle("default"),a.classList.toggle("show");const b=a.previousElementSibling;b&&toggleAttribute(b,ariaExpanded)}}),listen(getById("sidebar-toggler"),click,a=>{const b=getById("sidebar-container");if(b){b.classList.toggle(active);const c=a.currentTarget.querySelector("svg.icon");c&&c.classList.toggle("flipped")}})}handleSidebar();
"use strict";function selectTabsets(a,b){document.querySelectorAll(".tabset").forEach(c=>{c.querySelectorAll(".tab-strip").forEach(c=>{const d=c;d.dataset.categoryName===a&&d.querySelectorAll("[role=tab]").forEach(a=>{const c=a.getAttribute(ariaControls);if(c){const d=getById(c);d&&(a.dataset.categoryValue===b?(a.setAttribute(ariaSelected,"true"),a.removeAttribute(tabIndex),d.removeAttribute("hidden")):(a.removeAttribute(ariaSelected),a.setAttribute(tabIndex,"-1"),d.setAttribute("hidden","")))}})})})}function handleTabs(){document.querySelectorAll(".tabset").forEach(a=>{function b(a){c(),a.removeAttribute(tabIndex),a.setAttribute(ariaSelected,"true");const b=a.getAttribute(ariaControls);if(b){const a=getById(b);a&&a.removeAttribute("hidden")}}function c(){g.forEach(a=>{a.setAttribute(tabIndex,"-1"),a.setAttribute(ariaSelected,"false")}),f.forEach(a=>{a.setAttribute("hidden","")})}const d=a.querySelector(".tab-strip");if(!d)return;const e=d.dataset.categoryName,f=a.querySelectorAll("[role=tabpanel]"),g=[];d.querySelectorAll("[role=tab]").forEach(a=>{g.push(a)});const h=new KbdNav(g);if(e){const a=readLocalStorage(e);a&&selectTabsets(e,a)}d.querySelectorAll(button).forEach(a=>{listen(a,"focus",()=>{if(b(a),e){const b=a.dataset.categoryValue;b&&(localStorage.setItem(e,b),selectTabsets(e,b))}}),listen(a,"click",()=>{if(b(a),e){const b=a.dataset.categoryValue;b&&(localStorage.setItem(e,b),selectTabsets(e,b))}}),listen(a,keydown,a=>{const b=a,c=b.key;if(b.ctrlKey||b.altKey||b.metaKey);else if(b.shiftKey)isPrintableCharacter(c)&&h.focusElementByChar(c);else{switch(b.keyCode){case keyCodes.LEFT:h.focusPrevElement();break;case keyCodes.RIGHT:h.focusNextElement();break;case keyCodes.HOME:h.focusFirstElement();break;case keyCodes.END:h.focusLastElement();break;case keyCodes.TAB:return;default:isPrintableCharacter(c)&&h.focusElementByChar(c);}b.preventDefault(),b.cancelBubble=!0}})})})}handleTabs();
...
"use strict";let syntaxColoring=!0;function handleCodeBlocks(){function a(a){const c=document.createElement(button);c.title=buttonCopy,c.className="copy",c.innerHTML="<svg><use xlink:href='"+iconFile+"#copy'/></svg>",c.setAttribute(ariaLabel,buttonCopy),listen(c,mouseenter,a=>a.currentTarget.classList.add(f)),listen(c,mouseleave,a=>a.currentTarget.classList.remove(f)),listen(c,"focus",a=>a.currentTarget.classList.add(f)),listen(c,"blur",a=>a.currentTarget.classList.remove(f)),listen(c,click,a=>{const c=a.currentTarget.parentElement;if(c){const a=b(c);copyToClipboard(a)}return!0});const d=document.createElement("div");d.className="toolbar";const e=a.parentElement;e&&e.insertBefore(d,a),d.appendChild(a),d.appendChild(c),listen(a,mouseenter,a=>{const b=a.currentTarget,c=b.nextElementSibling;if(c){c.classList.add(f);const a=c.nextElementSibling;if(a){a.classList.add(f);const b=a.nextElementSibling;b&&b.classList.add(f)}}}),listen(a,mouseleave,a=>{const b=a.currentTarget,c=b.nextElementSibling;if(c){c.classList.remove(f);const a=c.nextElementSibling;if(a){a.classList.remove(f);const b=a.nextElementSibling;b&&b.classList.remove(f)}}})}function b(a){const b=a.getElementsByClassName("command");if(null!==b&&0<b.length){const a=b[0].innerText,c=a.split("\n");let d="";for(let a=0;a<c.length;a++)c[a].startsWith("$ ")&&(c[a]=c[a].substring(2)),""!==d&&(d+="\n"),d+=c[a];return d}return a.innerText}function c(a){const b=a.firstElementChild;if(null==b)return;let c="";for(const d of b.classList)if(d&&d.startsWith("language-bash")){c=d;break}if(""!==c){let a=0;const d=b.innerText.split("\n"),e=RegExp(/<<\s*\\?EOF/);let f="",g=!1,h=!1,i="";for(let b=0;b<d.length;b++){const c=d[b];if(c.startsWith("$ "))""!==i&&(syntaxColoring?f+="$ "+Prism.highlight(i,Prism.languages.bash,"bash")+"\n":f+="$ "+i+"\n"),i=c.slice(2),e.test(c)&&(h=!0);else if(g)i+="\n"+c,e.test(c)&&(h=!0);else if(h)i+="\n"+c,"EOF"===c&&(h=!1);else{a=b;break}g=c.endsWith("\\")}if(""!==i&&(syntaxColoring?f+="$ "+Prism.highlight(i,Prism.languages.bash,"bash")+"\n":(f+="$ "+i+"\n",f=f.replace(/</g,"&lt;").replace(/>/g,"&gt;"))),""!==f){"true"===b.dataset.expandlinks&&(f=f.replace(/@(.*?)@/g,"<a href='https://raw.githubusercontent.com/istio/"+b.dataset.repo+"/"+branchName+"/$1'>$1</a>"));let e="<div class='command'>"+f+"</div>",g="";if(0<a)for(let b=a;b<d.length;b++)""!==g&&(g+="\n"),g+=d[b];""!==g&&(g=g.replace(/</g,"&lt;").replace(/>/g,"&gt;"),b.dataset.outputis&&syntaxColoring&&(g=Prism.highlight(g,Prism.languages[b.dataset.outputis],b.dataset.outputis)),e+="<div class='output'>"+g+"</div>"),b.innerHTML=e,b.classList.remove(c),b.classList.add("command-output")}else syntaxColoring&&Prism.highlightElement(b,!1)}else syntaxColoring&&Prism.highlightElement(b,!1)}function d(a){const b=a.firstElementChild;b&&b.dataset.src&&function(d,f){fetch(f).then(a=>200===a.status?a.text():"Unable to access "+f+": "+a.statusText).catch(a=>"Unable to access "+f+": "+a).then(e=>{if(b.dataset.snippet){const a="\\#.*?\\$snippet "+b.dataset.snippet+"\\n(.*?)\\n\\#.+?\\$endsnippet",c=new RegExp(a,"gms");let d="",f=c.exec(e);for(;null!==f;)""!==d&&(d+="\n"),d+=f[1],f=c.exec(e);e=d}d.textContent=e,c(a)})}(b,b.dataset.src)}function e(){const a=readLocalStorage(g);"true"===a?syntaxColoring=!0:"false"===a&&(syntaxColoring=!1);const b=getById(h);b&&(syntaxColoring?b.classList.add(active):b.classList.remove(active)),listen(getById(h),click,()=>{localStorage.setItem(g,syntaxColoring?"false":"true"),location.reload()})}const f="toolbar-show",g="syntax-coloring",h="syntax-coloring-item";e(),document.querySelectorAll("pre").forEach(b=>{a(b),c(b),d(b)})}handleCodeBlocks();
"use strict";function handleLinks(){function a(a){if(""!==a.id){const b=document.createElement("a");b.className="self-link",b.href="#"+a.id,b.setAttribute("aria-hidden","true"),b.innerHTML="<svg class='icon'><use xlink:href='"+iconFile+"#links'/></svg>",a.appendChild(b)}}(function(){document.querySelectorAll("h2").forEach(a),document.querySelectorAll("h3").forEach(a),document.querySelectorAll("h4").forEach(a),document.querySelectorAll("h5").forEach(a),document.querySelectorAll("h6").forEach(a),document.querySelectorAll("dt").forEach(a)})(),function(){document.querySelectorAll("a").forEach(a=>{a.hostname&&a.hostname!==location.hostname&&(a.setAttribute("target","_blank"),a.setAttribute("rel","noopener"))})}(),function(){const a=getById("endnotes");if(!a)return;const b=document.getElementsByTagName("article")[0],c=new Map(null);let d=0;if(b.querySelectorAll("a").forEach(b=>{if(b.pathname===location.pathname)return;if(b.pathname.endsWith("/")&&""!==b.hash)return;if(b.classList.contains("btn"))return;if("true"===b.dataset.skipendnotes)return;let e=c.get(b.href);if(void 0===e){e=c.size+1,c.set(b.href,e);const d=document.createElement("li");d.innerText=b.href,a.appendChild(d)}b.insertAdjacentHTML("afterend","<sup class='endnote-ref' aria-hidden='true'>"+e+"</sup>"),d++}),0<d){const a=getById("endnotes-container");a&&a.classList.add("show")}}()}handleLinks();
"use strict";function observeResize(a,b){if(window.ResizeObserver){const c=new ResizeObserver(a=>{for(let c of a)b(c.target)});c.observe(a)}else listen(window,"resize",()=>{b(a)})}
"use strict";let scrollToTopButton,tocLinks,pageHeader,tocHeadings=[];function handleScroll(){function a(){function a(){scrollToTopButton&&(300<document.body.scrollTop||300<document.documentElement.scrollTop?scrollToTopButton.classList.add("show"):scrollToTopButton.classList.remove("show"))}function b(){if(tocLinks){let a=-1,b=1e6,d=-1,e=-1e6;for(let f=0;f<tocLinks.length;f++){const g=tocHeadings[f];if(!g)continue;const h=document.createRange();h.setStart(g,0),h.setEnd(g,1);const i=h.getBoundingClientRect();(i.width||i.height)&&(i.top>=c&&i.top<window.innerHeight?i.top+i.height-1<window.innerHeight&&i.top+i.height-1<b&&(a=f,b=i.top):i.top<c&&i.top>e&&(d=f,e=i.top)),tocLinks[f].classList.remove("current")}0<=a?tocLinks[a].classList.add("current"):0<=d&&tocLinks[d].classList.add("current")}}const c=pageHeader?pageHeader.getBoundingClientRect().height:0;a(),b();const d=document.querySelector(":target");d&&"TR"===d.tagName&&!d.dataset.scrolled&&(document.documentElement.scrollTop-=c,d.dataset.scrolled="true")}scrollToTopButton=getById("scroll-to-top"),listen(scrollToTopButton,click,()=>{document.body.scrollTop=0,document.documentElement.scrollTop=0});const b=getById("toc");if(b){tocLinks=b.getElementsByTagName("a");for(const a of tocLinks)if(a){const b=decodeURIComponent(a.hash.substring(1)),c=getById(b);c&&tocHeadings.push(c)}}pageHeader=document.getElementsByTagName("header")[0],a(),listen(window,"scroll",a)}handleScroll();
"use strict";let overlay=null,popper=null;function toggleOverlay(a){overlay===a?closeActiveOverlay():(overlay&&closeActiveOverlay(),a.classList.add("show"),overlay=a)}function showOverlay(a){overlay===a||(closeActiveOverlay(),a.classList.add("show"),overlay=a)}function closeActiveOverlay(){overlay&&(overlay.classList.remove("show"),overlay=null,popper&&(popper.destroy(),popper=null))}function handleOverlays(){function a(a,b){popper&&popper.destroy(),popper=new Popper(a,b,{modifiers:{flip:{enabled:!0},preventOverflow:{enabled:!0},shift:{enabled:!0}},placement:"auto-start"})}document.querySelectorAll(".term").forEach(b=>{const c=document.createElement("i");c.innerHTML="<svg class='icon'><use xlink:href='"+iconFile+"#glossary'/></svg>";const d=document.createElement("span");d.innerText=" "+b.dataset.title;const e=document.createElement("div");e.className="title",e.appendChild(c),e.appendChild(d);const f=document.createElement("div");f.className="body",b.dataset.body&&(f.innerHTML=b.dataset.body);const g=document.createElement("div");g.className="arrow",g.setAttribute("x-arrow","");const h=document.createElement("div");h.className="popover",h.appendChild(e),h.appendChild(f),h.appendChild(g),h.setAttribute("aria-hidden","true"),listen(h,click,a=>{a.cancelBubble=!0});const i=b.parentElement;i&&i.insertBefore(h,b.nextElementSibling),b.removeAttribute("data-title"),b.removeAttribute("data-body"),listen(b,click,c=>{c.cancelBubble=!0,toggleOverlay(h),a(b,h)})}),document.querySelectorAll(".update-notice").forEach(b=>{const c=document.createElement("i");c.innerHTML="<svg class='icon'><use xlink:href='"+iconFile+"#callout-tip'/></svg>";const d=document.createElement("span");d.innerText=" "+b.dataset.title;const e=document.createElement("div");e.className="title",e.appendChild(c),e.appendChild(d);const f=document.createElement("div");f.className="body",f.innerHTML="<p>"+b.dataset.updateadvice+"</p><a class='btn wide' href='"+b.dataset.updatehref+"'>"+b.dataset.updatebutton+"</a><a class='btn wide' target='_blank' rel='noopener' href='"+b.dataset.downloadhref+"'>"+b.dataset.downloadbuttontext+"</a>";const g=document.createElement("div");g.className="arrow",g.setAttribute("x-arrow","");const h=document.createElement("div");h.className="popover",h.appendChild(e),h.appendChild(f),h.appendChild(g),h.setAttribute("aria-hidden","true"),listen(h,click,a=>{a.cancelBubble=!0});const i=b.parentElement;i&&i.insertBefore(h,b.nextElementSibling),b.removeAttribute("data-title"),b.removeAttribute("data-downloadhref"),b.removeAttribute("data-updatehref"),b.removeAttribute("data-updateadvice"),b.removeAttribute("data-updatebutton"),listen(b,click,c=>{c.cancelBubble=!0,toggleOverlay(h),a(b,h)})}),listen(window,click,closeActiveOverlay),listen(window,"resize",closeActiveOverlay)}handleOverlays();
"use strict";const languages=["en","zh","pt-br"];function handleLanguageSwitch(){function a(a){const b=new URL(window.location.href),c=b.pathname;let d="",e="";const f=/\/v\d+\.\d+\//;if(c.startsWith("/latest")||f.test(c)){const a=c.indexOf("/",1);d=c.substr(0,a+1),e=c.substr(a)}for(const b of languages)if(e.startsWith("/"+b)){e=e.substr(3);break}""===a&&(a=languages[0]),createCookie("nf_lang",a),"en"===a&&(a="",d=d.substr(0,d.length)),b.pathname=d+a+e,navigateToUrlOrRoot(b.toString())}listen(getById("switch-lang"),click,()=>(a(""),!0));for(const b of languages)listen(getById("switch-lang-"+b),click,()=>{a(b)})}handleLanguageSwitch();
"use strict";const callToActionDelayMs=250;function handleCallToAction(){window.setTimeout(()=>{document.querySelectorAll(".call-to-action").forEach(a=>{a.style.opacity="1"})},callToActionDelayMs)}handleCallToAction();
"use strict";function handleEvents(){function a(){const a=readLocalStorage("remainingEventImpressions");for(const b in null!=a&&(f=JSON.parse(a)),f)if(f.hasOwnProperty(b)){const a=parseInt(f[b].periodEnd,10);e>a&&delete f[b]}}function b(){localStorage.setItem("remainingEventImpressions",JSON.stringify(f))}function c(a){document.querySelectorAll("."+a).forEach(a=>{if(!a.dataset.title||!a.dataset.periodStart||!a.dataset.periodEnd)return;const c=a.dataset.title,g=parseInt(a.dataset.periodStart,10),h=parseInt(a.dataset.periodEnd,10)+86400000-1;let i=0;a.dataset.maxImpressions&&(i=parseInt(a.dataset.maxImpressions,10)),0===i&&(i=1e6);let j=0;a.dataset.timeout&&(j=parseInt(a.dataset.timeout,10));let k=!1;if(e>=g&&e<=h){if(f[c]){let a=f[c].impressions;0<a&&(a--,f[c].impressions=a,k=!0)}else f[c]={},f[c].impressions=i-1,f[c].periodEnd=h,k=!0;k&&(a.style.display="block",0<j&&window.setTimeout(()=>a.style.display="none",1e3*j)),listen(a,click,()=>{a.style.display="none",f[c].impressions=0,b()}),a.querySelectorAll(".countdown").forEach(a=>{d(a,h),window.setInterval(()=>d(a,h),1e3)})}})}function d(a,b){const c=b-new Date().valueOf()-86400000,d=Math.round(c/86400000);"days"===a.dataset.type?a.innerText=d.toString():"full"===a.dataset.type&&(0<d?a.innerText=d+"d "+new Date(c).toISOString().substr(11,8):a.innerText=new Date(c).toISOString().substr(11,8))}const e=new Date().valueOf();let f={};a(),c("banner"),c("sticker"),b()}handleEvents();
